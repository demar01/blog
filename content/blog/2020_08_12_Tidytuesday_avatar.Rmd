...
glm_fit %>%
  tidy() %>%
  arrange(-estimate) %>% slice(1:3,124:126)
```
Episodes based on scripts written by Tim Hedrick, Joshua Hamilton, John O'Bryan are more likely to get higher Imdb ratings. On the other hand, episodes directed by Giancarlo Volpe and Lauren MacMullan are more likely t get lower Imdb ratings
